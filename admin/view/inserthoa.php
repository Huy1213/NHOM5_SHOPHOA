...
<main>
    ...
    <div class="container">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="Ten_Hoa" placeholder="" >
        </div>
        <div class="mb-3">
            <label for="SoLuong" class="form-label">Số Lượng</label>
            <input type="number" class="form-control" name="So_Luong" placeholder="" >
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" name="Don_Gia" placeholder="" >
        </div>
        <!-- <div class="mb-3">
